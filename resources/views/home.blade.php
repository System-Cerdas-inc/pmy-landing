        ...
        <div class="container">
            <div class="row gy-4">
                <div class="col-lg-6 order-2 order-lg-1 d-flex flex-column justify-content-center">
                    ...
                    <br>
                    @if (!empty($data_postingan_harga))
                        @if (!is_numeric($data_postingan_harga))
                            <h2 data-aos="fade-up" class="mb-3">Mulai Dari Rp. 0/Bulan*</h2>
                        @else
                            <h2 data-aos="fade-up" class="mb-3">Mulai Dari Rp.
                                {{ number_format($data_postingan_harga, 0, ',', '.') }}/Bulan*</h2>
                        @endif
                    @else
                        <h2 data-aos="fade-up" class="mb-3">Mulai Dari Rp. 0/Bulan*</h2>
                    @endif
                            ...
                            <div class="faq-item">
                                ...
                                <div class="faq-content">
                                    <p>
                                        {{ $item->keterangan }}
                                        <br>
                                        <iframe width="640" height="360" src="{{ $item->link_video }}" frameborder="0"
